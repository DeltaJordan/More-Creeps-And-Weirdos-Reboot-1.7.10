...
public class CREEPSGUISneakySal extends GuiScreen
{
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        for (int j1 = 0; j1 < 5; j1++)
        {
            ...
            CREEPSEntitySneakySal _tmp = sneakysal;
            GuiContainer.itemRender.renderItemIntoGUI(fontRendererObj, this.mc.getTextureManager(), CREEPSEntitySneakySal.itemstack[sneakysal.salslots[j1 * 2]], width / 2 - 160, height / 4 + 8 + byte0 + j1 * 30);
            CREEPSEntitySneakySal _tmp1 = sneakysal;
            GuiContainer.itemRender.renderItemIntoGUI(fontRendererObj, this.mc.getTextureManager(), CREEPSEntitySneakySal.itemstack[sneakysal.salslots[j1 * 2 + 1]], width / 2 + 12, height / 4 + 8 + byte0 + j1 * 30);
            GL11.glDisable(GL11.GL_LIGHTING);
