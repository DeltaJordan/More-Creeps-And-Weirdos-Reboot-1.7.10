...
public class CREEPSRenderHotdog extends RenderLiving
{
    ...
    public void doRenderLiving(EntityLiving entityliving, double d, double d1, double d2, float f, float f1)
    {
        ...
        if (f4 < 20F && s.length() > 0)
        {
            ...
            tessellator.addVertex(-25F + f9, -10 + i, 0.0D);
            tessellator.addVertex(-25F + f9, -6 + i, 0.0D);
            tessellator.addVertex(25D, -6 + i, 0.0D);
            tessellator.addVertex(25D, -10 + i, 0.0D);
            tessellator.setColorRGBA_F(0.0F, 1.0F, 0.0F, 1.0F);
            tessellator.addVertex(-25D, -10 + i, 0.0D);
            tessellator.addVertex(-25D, -6 + i, 0.0D);
            tessellator.addVertex(f9 - 25F, -6 + i, 0.0D);
            tessellator.addVertex(f9 - 25F, -10 + i, 0.0D);
            tessellator.draw();
    ...
    public void burnDog(Entity entity, double d, double d1, double d2, float f)
    {
        ...
        while (f9 > 0.0F)
        {
        	tessellator.addVertexWithUV(f6 - f7, (0.0F - f8) + (float)i, 0.0D, f2, f4);
        	tessellator.addVertexWithUV(0.0F - f7, (0.0F - f8) + (float)i, 0.0D, f1, f4);
        	tessellator.addVertexWithUV(0.0F - f7, (1.4F - f8) + (float)i, 0.0D, f1, f3);
        	tessellator.addVertexWithUV(f6 - f7, (1.4F - f8) + (float)i, 0.0D, f2, f3);
            f9--;
            f8--;
            f6 *= 0.9F;
        ...
        while (f9 > 0.0F)
        {
        	tessellator.addVertexWithUV(f6 - f7++, (0.0F - f8) + (float)i, 0.0D, f2 + 6F, f4);
        	tessellator.addVertexWithUV(0.0F - f7++, (0.0F - f8) + (float)i, 0.0D, f1 + 6F, f4);
        	tessellator.addVertexWithUV(0.0F - f7++, (1.4F - f8) + (float)i, 0.0D, f1 + 6F, f3);
        	tessellator.addVertexWithUV(f6 - f7++, (1.4F - f8) + (float)i, 0.0D, f2 + 6F, f3);
            f9--;
            f8--;
            f6 *= 0.9F;
            GL11.glTranslatef(0.0F, 0.0F, -0.04F);
